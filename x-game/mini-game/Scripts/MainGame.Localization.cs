...
sector.2.trait|Spores drift through space. Enemies arrive heavier, but repairs are more common.|敌人更厚重，但修复掉落更多。|Враги прочнее, но ремонт выпадает чаще.|Inimigos mais duros, reparos mais frequentes.|Feinde sind zäher, Reparaturen fallen öfter.|Düşmanlar daha sert, onarım daha sık düşer.|Ennemis plus lourds, réparations plus fréquentes.|敵は硬いが、修理ドロップが増える。
...
sector.3.trait|Time shears the arena. Bullets pulse faster and slower in alternating bars.|时间切割战场，弹幕会忽快忽慢。|Время режет арену, пули пульсируют то быстрее, то медленнее.|O tempo corta a arena; tiros alternam ritmo.|Zeit schert die Arena, Kugeln wechseln ihr Tempo.|Zaman arenayı keser, mermiler ritim değiştirir.|Le temps cisaille l’arène et les tirs changent de cadence.|時間が戦場を裂き、弾速が脈打つ。
sector.4.name|Solar Wound|太阳裂口|Солнечная рана|Ferida Solar|Sonnenwunde|Güneş Yarası|Plaie solaire|太陽裂傷
sector.4.trait|Final sector. Elite enemies and solar lances try to end the pattern.|最终章。精英与太阳长枪会压到极限。|Финал. Элита и солнечные копья давят до предела.|Setor final. Elites e lanças solares apertam o cerco.|Finale. Elite und Sonnenlanzen erhöhen den Druck.|Son bölge. Elitler ve güneş mızrakları bastırır.|Secteur final. Élites et lances solaires ferment l’étau.|最終域。精鋭と太陽槍が限界まで迫る。
...
hud.spawn.combo|COMBO +{0}%|连击 +{0}%|КОМБО +{0}%|COMBO +{0}%|KOMBO +{0}%|KOMBO +{0}%|COMBO +{0}%|コンボ +{0}%
hud.spawn.boss|--|--|--|--|--|--|--|--
...
guide.combo.1|Higher combo raises SPAWN speed. Even at zero combo, later sectors spawn faster.|连击越高，刷新越快。即使没有连击，越到后期敌人刷新也会越快。|Высокое комбо ускоряет спавн. Даже без комбо поздние секторы быстрее.|Combo alto acelera SPAWN. Mesmo sem combo, setores tardios aceleram.|Hohe Kombo erhöht SPAWN. Auch ohne Kombo werden spätere Sektoren schneller.|Yüksek kombo DOĞUŞ hızını artırır. Kombosuz bile geç sektörler hızlanır.|Plus de combo accélère les APPAR. Même sans combo, les secteurs tardifs vont plus vite.|高コンボで出現速度上昇。コンボなしでも後半ほど速くなる。
