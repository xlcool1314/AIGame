...
hud.controls|WASD/LS MOVE  AUTO LOCK  AUTO FIRE  A/LB DASH  X/RB SKILL  Y/RT ULT  START MENU|WASD/左摇杆移动  自动锁敌  自动开火  A/LB冲刺  X/RB技能  Y/RT大招  Start菜单|WASD/LS ДВИЖ.  АВТОЗАХВАТ  АВТООГОНЬ  A/LB РЫВОК  X/RB НАВЫК  Y/RT УЛЬТ|WASD/LS MOVER  TRAVA AUTO  AUTO  A/LB DASH  X/RB HABIL.  Y/RT ULT|WASD/LS BEWEGEN  AUTO-LOCK  AUTOFEUER  A/LB SPRINT  X/RB SKILL  Y/RT ULT|WASD/LS HAREKET  OTO KİLİT  OTO ATEŞ  A/LB ATIL  X/RB YETENEK  Y/RT ULTI|WASD/LS BOUGER  VERROU AUTO  AUTO  A/LB DASH  X/RB COMP.  Y/RT ULT|WASD/LS移動  自動ロック  自動射撃  A/LBダッシュ  X/RBスキル  Y/RT奥義
...
guide.basic.0|Move with WASD, arrows, or left stick. Weapons automatically lock on to enemies and fire.|WASD、方向键或左摇杆移动。武器会自动锁定敌人并开火。|WASD, стрелки или левый стик для движения. Оружие само захватывает врагов и стреляет.|Mova com WASD, setas ou analógico esquerdo. Armas travam em inimigos e disparam sozinhas.|WASD, Pfeile oder linker Stick bewegen. Waffen erfassen Feinde automatisch und feuern.|WASD, yön tuşları veya sol çubuk hareket. Silahlar düşmanı otomatik kilitler ve ateş eder.|WASD, flèches ou stick gauche pour bouger. Les armes verrouillent les ennemis et tirent seules.|WASD、矢印、左スティックで移動。武器は敵を自動ロックして射撃。
...
guide.0|Move with WASD, arrows, or left stick. Weapons automatically lock on to enemies and fire.|WASD / 方向键 / 左摇杆移动。武器会自动锁定敌人并开火。|WASD, стрелки или левый стик для движения. Оружие само захватывает врагов и стреляет.|Mova com WASD, setas ou analógico esquerdo. Armas travam em inimigos e disparam sozinhas.|WASD, Pfeile oder linker Stick bewegen. Waffen erfassen Feinde automatisch und feuern.|WASD, yön tuşları veya sol çubuk hareket. Silahlar düşmanı otomatik kilitler ve ateş eder.|WASD, flèches ou stick gauche. Les armes verrouillent les ennemis et tirent seules.|WASD/矢印/左スティックで移動。武器は敵を自動ロックして射撃。
