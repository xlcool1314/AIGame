...
public static class Localization
{
	...
	private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
	{
		[Chinese] = new Dictionary<string, string>
		{
			...
			["route_map_legend"] = "路线图：当前 / 可进入 / 可规划 / 已错过    战=战斗  矿=探勘  ?=事件  休=休整  商=商店  校=校准",
			["route_current"] = "当前位置",
			["route_available"] = "可进入",
			["route_future"] = "可规划",
			["route_lost"] = "已错过",
		...
		[English] = new Dictionary<string, string>
		{
			...
			["route_map_legend"] = "Route Map: Current / Available / Planned / Lost    B=Battle  M=Survey  ?=Event  R=Rest  S=Shop  T=Tune",
